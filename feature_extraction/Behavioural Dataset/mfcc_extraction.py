...
def process_files(input_dir, output_dir, n_mfcc=60, window_length_s=0.06, hop_length_s=0.01, window_type="hamming", n_mels=60, remove_non_voiced=True):
    """
...
if __name__ == "__main__":
    ...
    output_dir = "/home/blea0003/au_mfcc/MFCCAnnotations/60_60_60_60/Type 01"
    process_files(source_dir, output_dir, n_mfcc=60, window_length_s=0.06, hop_length_s=0.06, window_type="hamming", n_mels=60, remove_non_voiced=True)
